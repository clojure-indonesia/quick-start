...
var i_646 = (self__.level + (1));
while(true){
if((i_646 <= (new_level + (1)))){
(update[i_646] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_648 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_648[i]));
} else {
x__$2.forward.push((((i < links_648.length))?(links_648[i]):null));
}

if((i < links_648.length)){
(links_648[i] = x__$2);
} else {
links_648.push(x__$2);
}
...
var i_650 = (0);
while(true){
if((i_650 <= self__.level)){
var links_651 = (update[i_650]).forward;
if((x__$1 === (((i_650 < links_651.length))?(links_651[i_650]):null))){
(links_651[i_650] = (x__$1.forward[i_650]));
...
var G__655 = nx;
var G__656 = (level__$1 - (1));
x = G__655;
level__$1 = G__656;
continue;
} else {
var G__657 = x;
var G__658 = (level__$1 - (1));
x = G__657;
level__$1 = G__658;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__660 = nx;
var G__661 = (level__$1 - (1));
x = G__660;
level__$1 = G__661;
continue;
} else {
var G__662 = x;
var G__663 = (level__$1 - (1));
x = G__662;
level__$1 = G__663;
continue;
}
